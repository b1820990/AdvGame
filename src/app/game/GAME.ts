...
export const ROOMS: Room[] = [
    ...
    new Room("Room 7","/assets/rooms/7.png", room7Options, "The combined light of the three artifacts form the divine sword Castiel. Flying towards the undead lich with your boots, you disable his magical guard and bypass his magical shield, piercing his skull with a devastating blow. Panting, you leave the dungeon, confident of your victory."),
